...
SIPOS merupakan aplikasi klien dan membutuhkan backend SIINV yang kompatibel, akun kasir yang valid, serta sesi stok harian aktif. Harga, akses cabang, ketersediaan menu, mutasi stok, dan otorisasi transaksi tetap ditentukan oleh backend.
...
- Katalog menu berpaginasi dan tersimpan pada cache lokal, lengkap dengan kategori, gambar varian, harga, dan ketersediaan berbasis stok.
...
- Android Studio yang mendukung Android Gradle Plugin 9.0.1.
...
Sebelum rilis, verifikasi aplikasi menggunakan backend SIINV tujuan, akun kasir yang representatif, skenario transaksi, dan perangkat printer Bluetooth yang akan digunakan.
...
- Laporkan celah keamanan secara privat kepada pemilik proyek dan jangan menyertakan kredensial atau data operasional pada laporan issue.

## Catatan Integrasi

- Aplikasi membutuhkan backend SIINV, akun kasir yang valid, dan sesi aktif.
- Alur pembayaran yang tersedia menggunakan metode tunai.
...
- Pengujian OTP email, printer Bluetooth, dan transaksi end-to-end membutuhkan layanan, perangkat, dan data uji yang sesuai.
...
Gunakan commit yang terfokus, sertakan pengujian untuk perubahan perilaku, dan dokumentasikan perubahan kontrak API yang memengaruhi kompatibilitas SIINV. Pull request ditinjau berdasarkan prioritas proyek dan kebutuhan kompatibilitas.
