...
new_block = '''    if (transactionToVoid != null && isSelectedDateToday) {
        Dialog(
...
start_str = "    if (transactionToVoid != null && isSelectedDateToday) {"
end_str = "    Column(\n        modifier = modifier\n            .fillMaxSize()\n            .background(KebabBg)\n    )"
...
if start_idx != -1 and end_idx != -1:
    ...
    print(f"Failed to find block boundaries. start_idx: {start_idx}, end_idx: {end_idx}")
