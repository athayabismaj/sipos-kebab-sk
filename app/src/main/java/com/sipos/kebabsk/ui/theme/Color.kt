...
val BrownMid = Color(0xFF475467)           // Neutral secondary ink
val CreamBg = Color(0xFFF6F7F9)            // Calm neutral application background
val CreamSurface = Color(0xFFFFFFFF)      // Pure white surface
val GreyVariant = Color(0xFF667085)        // Neutral grey for subtitles
...
val KebabIconBg = Color(0xFFF2F4F7)
